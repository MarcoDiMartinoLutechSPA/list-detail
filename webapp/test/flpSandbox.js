		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Lista Dettagli",
									"targetURL": "#sapbtplistdetail-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapbtplistdetail-display": {
								"semanticObject": "sapbtplistdetail",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.btp.listdetail",
									"url": sap.ui.require.toUrl("sap/btp/listdetail")
								}
							}
						}
					}
